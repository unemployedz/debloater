      ...
      return (
        <div style={{minHeight:'100vh',display:'grid',placeItems:'center',background:'#05070d',color:'#f4f7ff',fontFamily:'system-ui,-apple-system,sans-serif',padding:'24px',boxSizing:'border-box'}}>
          <div style={{width:'min(760px,100%)',border:'1px solid rgba(120,160,255,.22)',borderRadius:'18px',padding:'28px',background:'rgba(10,15,28,.94)',boxShadow:'0 20px 80px rgba(0,0,0,.45)'}}>
            ...
            <p style={{margin:'0 0 18px',color:'#9aa9c2',lineHeight:1.6}}>React itself is working. This error comes from loading or rendering the application component.</p>
            <pre style={{whiteSpace:'pre-wrap',overflowWrap:'anywhere',margin:0,padding:'14px',borderRadius:'10px',background:'#02040a',color:'#ffb4b4',fontSize:'12px'}}>{String(error?.stack || error?.message || error)}</pre>
